...
from profasi.ProfasiEnsembleRestrictedEnergy import ProfasiEnsembleRestrictedEnergy
...
platform-specific options.'''
        ...
        if simulation_type == "PROFASI":
            ...
            return ensemble
        elif simulation_type == "PROFASI-RESTRICTED":
            print "trying to create restricted energy ensemble"
            ensemble = ProfasiEnsembleRestrictedEnergy(log_level)
            ensemble.set_settings(directory, beta, iteration_range, **platform_specific_args)
            return ensemble
        else:
